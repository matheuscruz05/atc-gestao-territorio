...
console.log(
  "[API] GOOGLE_SERVICE_ACCOUNT_JSON:",
  process.env.GOOGLE_SERVICE_ACCOUNT_JSON
    ? "SET (" + process.env.GOOGLE_SERVICE_ACCOUNT_JSON.substring(0, 50) + "...)"
    : "NOT SET"
);
console.log(
  "[API] EXPO_PUBLIC_GOOGLE_SHEETS_ID:",
  process.env.EXPO_PUBLIC_GOOGLE_SHEETS_ID ? "SET" : "NOT SET"
);
console.log(
  "[API] GOOGLE_SHEETS_ID:",
  process.env.GOOGLE_SHEETS_ID ? "SET" : "NOT SET"
);
console.log(
  "[API] GOOGLE_SERVICE_ACCOUNT_KEY_FILE:",
  process.env.GOOGLE_SERVICE_ACCOUNT_KEY_FILE ? "SET" : "NOT SET"
);
...
app.get("/api/diagnose", (_req, res) => {
  res.json({
    ...
    environment_variables: {
      ...
      EXPO_PUBLIC_GOOGLE_SHEETS_ID: process.env.EXPO_PUBLIC_GOOGLE_SHEETS_ID
        ? "✅ SET (" + process.env.EXPO_PUBLIC_GOOGLE_SHEETS_ID.substring(0, 20) + "...)"
        : "❌ NOT SET",
      ...
      GOOGLE_SERVICE_ACCOUNT_KEY_FILE: process.env.GOOGLE_SERVICE_ACCOUNT_KEY_FILE
        ? "✅ SET"
        : "❌ NOT SET",
      EXPO_PUBLIC_GOOGLE_SHEETS_API_KEY: process.env.EXPO_PUBLIC_GOOGLE_SHEETS_API_KEY
        ? "✅ SET"
        : "❌ NOT SET",
    },
